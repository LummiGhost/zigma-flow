...
- `agent_invoked` — backend 启动子进程，payload 含 backend_name、command、args_hash、timeout_ms、step_artifact_dir；v0.9 增量：可选 model、routing_reason（Issue #286 Phase 1；Phase 3 起历史排序时 routing_reason 携带 `history-ranked ...` 依据）
